...
// v5 already dropped valkyrienskies from its incompatibleMods list, so this is only needed on v4.
@Pseudo
@Mixin(targets = "com.github.exopandora.shouldersurfing.forge.ShoulderSurfingForge", remap = false)
public abstract class MixinSuppressSsrVsIncompatWarningV4 {
